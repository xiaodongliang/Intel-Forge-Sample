...
///Ali Cloud MQ
#define ADDRESS "<Ali MQ host> 
#define Ali_UserName "<Ali MQ user name>"
#define Ali_Password "<Ali MQ password>" 
#define Ali_ClientId "GID_Autodesk_Forge@@@AutodeskForgeDevice" 
#define TOPIC_ONE   "adsk_forge_iot"   //for ali cloud MQ  
////end Ali Cloud MQ 
...
main() {
  ...
  MQTTAsync_create(&client, ADDRESS, Ali_ClientId, MQTTCLIENT_PERSISTENCE_NONE, NULL);
  ...
  ///Ali Cloud MQ 
  conn_opts.username = Ali_UserName;
	conn_opts.password = Ali_Password; 
